tiens un prompt encore plus precis de ce a quoi ca doit ressembler a la fin # NONO_SIMU_2D
...
```text
jour 50 → village devient ville
jour 100 → royaume apparaît
jour 150 → guerre
jour 200 → religion
```
...
```text
An 34 :
Une famille découvre un important gisement de fer.

An 37 :
Une mine est construite.
...
An 53 :
Des marchands étrangers arrivent.

An 61 :
Le village devient un centre commercial.

An 68 :
Une guilde de forgerons est créée.

An 74 :
Un conseil municipal est formé.

An 81 :
Une route commerciale relie la ville à une région voisine.
```
...
Le monde doit être capable de **surprendre son propre créateur**. et sur la partie visuelle # NONO_SIMU_2D
...
Il doit rendre **l'émergence visible**.  tu as bcp de travaille a faire tt ca doit etre fonctionel sur la version que tu me rendras