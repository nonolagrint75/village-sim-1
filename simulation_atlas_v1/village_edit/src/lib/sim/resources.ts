...
export const RESOURCE_DEFS = [
  ...
  def('food', 'Baies', 'baies', 2.2, { kcal: 900, nutrition: 1, basePrice: 1.5, targetPerCapita: 3.5, tradeable: true, tags: ['edible', 'fruit'] }),
  ...
  def('bread', 'Pain', 'pain', 1.6, { kcal: 1400, nutrition: 2, basePrice: 2, targetPerCapita: 2.5, tradeable: true, tags: ['edible', 'craft'] }),
