...
/** Aligné sur `ages.ts` / politics / marriage — une seule échelle visuelle. */
export const APPEARANCE_CHILD_AGE = CHILD_AGE
/** Aligné sur `ages.ts` / politics.ELDER_AGE. */
export const APPEARANCE_ELDER_AGE = ELDER_AGE
