...
export const TASK_LABELS: Record<TaskKind, string> = {
  ...
  buildHearth: 'Maçonne un foyer',
  buildBench: 'Fabrique un banc',
  buildStool: 'Tourne un tabouret',
  buildShelf: 'Pose une étagère',
  buildCupboard: 'Monte un buffet',
  buildCradle: 'Fabrique un berceau',
  buildLoom: 'Dresse un métier à tisser',
  buildWashingTub: 'Installe une cuve à lessive',
